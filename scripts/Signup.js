$(document).ready(function () {
    ...
    // Refreshes the page to clear the form bc I couldn't find a better way uwu
              ...
              `<div class="container-fluid">
                <div row>
                  <div col>
                    ...
                    <p class="mt-3"> Thank you `+ elName.value +` for your generous donation. Expect to recieve an email at your address <b>`+ elEmail.value +` </b> in the next 2-3 business days 
                    detailing the location of our next meeting! We hope to see you soon, and rest easy knowing your gift will make a difference for our rescued canines. Please note that there will also be an opportunity to make a one time donation 
